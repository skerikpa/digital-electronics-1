...
create_clock -add -name sys_clk_pin -period 25000.00 -waveform {0 5} [get_ports {CLK100MHZ}];
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { JB_o }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { JC_i }]; #IO_L23N_T3_35 Sch=jc[1]
